...
const FoodRequest = () => {
  ...
  return (
    <StaffPageLayout eyebrow="Kitchen" title="Budget Requests" subtitle="Submit and track monthly kitchen budget requests.">
      <div className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card className="rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-50 to-cyan-50 p-5 dark:border-slate-700 dark:bg-none dark:bg-slate-800/50">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Total Requests</p>
          ...
          <Card className="rounded-2xl border border-slate-200 bg-gradient-to-br from-green-50 to-emerald-50 p-5 dark:border-slate-700 dark:bg-none dark:bg-slate-800/50">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Total Requested</p>
          ...
          <Card className="rounded-2xl border border-slate-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-5 dark:border-slate-700 dark:bg-none dark:bg-slate-800/50">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Total Approved</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="rounded-2xl border border-slate-200 p-6 dark:border-slate-700 dark:bg-slate-800/50">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-slate-100 mb-4">New Budget Request</h2>
          ...
          <div className="lg:col-span-2">
            {loading ? (
              <Card className="rounded-2xl border border-slate-200 p-8 text-center text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-400">Loading...</Card>
            ) : budgets.length === 0 ? (
              <Card className="rounded-2xl border border-slate-200 p-8 text-center text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-400">No budget requests found</Card>
            ) : (
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-200 dark:border-slate-700">
                        <th className="p-4 text-left font-semibold text-slate-600 dark:text-slate-300">Month/Year</th>
                        <th className="p-4 text-left font-semibold text-slate-600 dark:text-slate-300">Requested</th>
                        <th className="p-4 text-left font-semibold text-slate-600 dark:text-slate-300">Approved</th>
                        <th className="p-4 text-left font-semibold text-slate-600 dark:text-slate-300">Spent</th>
                        <th className="p-4 text-left font-semibold text-slate-600 dark:text-slate-300">Remaining</th>
                        <th className="p-4 text-left font-semibold text-slate-600 dark:text-slate-300">Remarks</th>
