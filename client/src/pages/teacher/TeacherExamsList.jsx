...
const statusColors = {
  ...
  finished: 'bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-300',
      ...
      <table className="w-full text-left text-sm">
        ...
        <tbody>
          {filtered.map((exam) => (
            <tr
              key={exam._id}
              className="border-b border-slate-100 transition last:border-0 hover:bg-slate-50 dark:border-slate-700/50 dark:hover:bg-slate-800/30"
            >
      ...
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="mb-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {statCards.map((c) => (
            <div
              key={c.label}
              className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/50"
            >
