...
const TeacherPayslips = () => {
          ...
          <tbody>
            {payslips.map((p) => (
              ...
              >
                ...
                <td className="px-5 py-4 text-slate-600 dark:text-slate-300">{fmt(p.grossSalary)}</td>
  ...
  return (
    <div className={PANEL_PAGE_BG}>
      ...
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 backdrop-blur-sm" onClick={() => setSelected(null)}>
