...
const Messages = () => {
 ...
 const fieldCls = 'rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-slate-400 dark:border-slate-600 dark:text-slate-200';
 ...
 <div className="flex flex-1 flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 ">
 ...
 <div className="max-w-lg rounded-3xl px-5 py-3 text-slate-800 dark:text-slate-100">
