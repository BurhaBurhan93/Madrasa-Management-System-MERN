...
const translations = {
  en: {
    ...
    subtitle: 'Manage the entire institution with a cleaner workspace and faster navigation.',
  ...
  const menuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'corrections', label: t.corrections, path: 'attendance/corrections' },
      ]
    },
    {
      id: 'finance',
      ...
      type: 'dropdown',
      items: [
        { id: 'fee-structure', label: t.feeStructure, path: 'finance/fee-structure' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'attendance', label: t.attendanceRpt, path: 'reports/attendance' },
        { id: 'operational', label: t.operationalRpt, path: 'reports/operational' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'notifications', label: t.notifications, path: 'settings/notifications' },
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className={`border-t p-3 ${theme === 'dark' ? 'border-slate-700/60' : 'border-slate-200/80'}`}>
            <div className={`rounded-3xl border p-2 ${theme === 'dark' ? 'border-slate-700/60 bg-slate-800/80' : 'border-slate-200 bg-white/95'} ${sidebarOpen ? '' : 'space-y-2'}`}>
              <button
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className={`mt-1 text-lg font-semibold lg:text-xl ${theme === 'dark' ? 'text-slate-100' : 'text-slate-900'}`}>
                  {t.welcome} <span className="bg-gradient-to-r from-cyan-600 to-sky-600 bg-clip-text text-transparent">{user?.name || 'Administrator'}</span>
                </h1>
