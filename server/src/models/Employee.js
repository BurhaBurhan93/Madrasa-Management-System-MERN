...
const EmployeeSchema = new Schema({
  ...
  // Employment Details
  employeeType: { type: String, enum: ['teacher','admin','finance','registrar','hr','librarian','kitchen','security','support','maintenance','payroll','complaints','inventory','general-manager'], default: 'support' },
